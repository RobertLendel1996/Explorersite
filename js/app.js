(() => {
    ...
    function initSliders() {
        if (document.querySelector(".destinations__slider")) new core(".destinations__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".destinations__slider .slider-destinations__button-prev",
                nextEl: ".destinations__slider .slider-destinations__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".specialoffer__slider")) new core(".specialoffer__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            loop: true,
            navigation: {
                prevEl: ".specialoffer__slider .slider-specialoffer__button-prev",
                nextEl: ".specialoffer__slider .slider-specialoffer__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".gallery__slider")) new core(".gallery__slider", {
            ...
            lazy: true,
            navigation: {
                prevEl: ".gallery__slider .slider-gallery__button-prev",
                nextEl: ".gallery__slider .slider-gallery__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".experiences__slider")) new core(".experiences__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".experiences__slider .slider-experiences__button-prev",
                nextEl: ".experiences__slider .slider-experiences__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
...
***************************************************************************** */
    ...
    da.init();
    let tripSlide = document.querySelectorAll(".trip__slide");
    tripSlide.forEach((tripSlide => {
        tripSlide.addEventListener("click", (function(e) {
            tripSlide.classList.toggle("_open");
        }));
    }));
